...
public class GlobalExceptionHandler {
    ...
    private static final String GENERIC_SERVER_ERROR_MESSAGE = "Something went wrong and we are trying to fix it!";
    ...
    public @ResponseBody ErrorResponse handleGenericException(Exception ex) {
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage(), GENERIC_SERVER_ERROR_MESSAGE);
    }
    ...
    private ErrorResponse buildErrorResponse(HttpStatus status, String errorMessage, String friendlyMessage) {
